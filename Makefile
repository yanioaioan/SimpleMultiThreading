#############################################################################
# Makefile for building: SimpleMutliThreading
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  SimpleMutliThreading.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile SimpleMutliThreading.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SimpleMutliThreading1.0.0
DISTDIR = /home/yioannidis/SimpleMutliThreading/.tmp/SimpleMutliThreading1.0.0
LINK          = g++
...
OBJECTS       = main.o
DIST          = deployment.pri \
		SimpleMutliThreading.pro  main.cpp
QMAKE_TARGET  = SimpleMutliThreading
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = SimpleMutliThreading
...
Makefile: SimpleMutliThreading.pro ../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		SimpleMutliThreading.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile SimpleMutliThreading.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/SimpleMutliThreading/bin || mkdir -p $(INSTALL_ROOT)/opt/SimpleMutliThreading/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/SimpleMutliThreading/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/SimpleMutliThreading/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/SimpleMutliThreading/bin/ 
